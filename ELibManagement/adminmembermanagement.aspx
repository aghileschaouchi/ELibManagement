                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox12" runat="server" placeholder="Full Postal Address" ReadOnly="True" TextMode="MultiLine" Rows="2"></asp:TextBox>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-8 mx-auto">
                                <asp:Button class="btn btn-lg btn-block btn-danger" ID="Button3" runat="server" Text="Delete User Permanently" OnClick="Button3_Click" />
                            </div>
                        </div>
